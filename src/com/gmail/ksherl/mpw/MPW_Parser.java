...
import com.gmail.ksherl.asm816.ContextMap;
...
import com.gmail.ksherl.expression.*;
import com.gmail.ksherl.omf.OMF;
import com.gmail.ksherl.omf.OMF_DS;
import com.gmail.ksherl.omf.OMF_Eof;
import com.gmail.ksherl.omf.OMF_Local;
import com.gmail.ksherl.omf.OMF_Opcode;
import com.gmail.ksherl.omf.OMF_Segment;
import com.gmail.ksherl.omf.OMF_Using;
...
public class MPW_Parser extends Parser
{
        ...
        throws AsmException
    {
       ...
       if (!(ti instanceof com.gmail.ksherl.asm816.NullTokenIterator))
        {
            ArrayList<Token> tmp;
        ...
        while (ml != null)
        {
            ...
            ti = ml.operand;
            if ((ti != null) && !(ml.operand instanceof com.gmail.ksherl.asm816.NullTokenIterator))
            {
        ...
        throws AsmException
    {
        ...
        for(int i = 0;!done;)
        {
            ...
            if (i == 1)
            {
                ...
                if (!(ml.operand instanceof com.gmail.ksherl.asm816.NullTokenIterator))
                {
