...
import com.gmail.sherl.asm816.ContextMap;
...
import com.gmail.sherl.expression.*;
import com.gmail.sherl.omf.OMF;
import com.gmail.sherl.omf.OMF_DS;
import com.gmail.sherl.omf.OMF_Eof;
import com.gmail.sherl.omf.OMF_Local;
import com.gmail.sherl.omf.OMF_Opcode;
import com.gmail.sherl.omf.OMF_Segment;
import com.gmail.sherl.omf.OMF_Using;
...
public class MPW_Parser extends Parser
{
        ...
        throws AsmException
    {
       ...
       if (!(ti instanceof com.gmail.sherl.asm816.NullTokenIterator))
        {
            ArrayList<Token> tmp;
        ...
        while (ml != null)
        {
            ...
            ti = ml.operand;
            if ((ti != null) && !(ml.operand instanceof com.gmail.sherl.asm816.NullTokenIterator))
            {
        ...
        throws AsmException
    {
        ...
        for(int i = 0;!done;)
        {
            ...
            if (i == 1)
            {
                ...
                if (!(ml.operand instanceof com.gmail.sherl.asm816.NullTokenIterator))
                {
