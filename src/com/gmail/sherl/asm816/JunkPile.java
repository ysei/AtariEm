...
import com.gmail.sherl.omf.OMF_Const;
...
public class JunkPile
{
    ...
    @SuppressWarnings("unchecked")
    public void add(com.gmail.sherl.expression.Expression data)
    {
        if (fTemp.CodeSize() > 0)
        {
            fData.add(fTemp.toConst());
    ...
    public void add_object(Object data)
    {
        ...
        if (data instanceof OMF_Opcode)
            ...
            add((byte[])data);
        else if (data instanceof com.gmail.sherl.expression.Expression)
            add((com.gmail.sherl.expression.Expression)data);
