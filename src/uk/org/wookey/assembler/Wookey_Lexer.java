...
public class Wookey_Lexer extends Lexer {
	private final static Logger _logger = new Logger(Wookey_Lexer.class.getName());

    public Wookey_Lexer(InputStream io) {
        super(io);
    }
    
    public Wookey_Lexer(String s) {
        super(s);
    }   
