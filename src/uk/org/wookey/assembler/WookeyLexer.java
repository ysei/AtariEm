...
public class WookeyLexer extends Lexer {
	private final static Logger _logger = new Logger(WookeyLexer.class.getName());

    public WookeyLexer(InputStream io) {
        super(io);
    }
    
    public WookeyLexer(String s) {
        super(s);
    }   
